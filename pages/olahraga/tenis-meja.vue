<template>
    <div class="text-center">
        <Head>
            <Title>Jadwal Pertandingan Tenis Meja di RW 09 Sukamulya Cikupa</Title>
            <Meta
            name="description"
            content="jadwal Pertandingan Tenis Meja RW 09 Sukamulya kecamatan cikupa Tangerang"
            />
        </Head>
        ...
        <div class="h-full bg-gradient-to-r from-cyan-500 to-blue-500 border-solid py-2 px-6 rounded-md">
            <div class="text-sm md:text-xl font-bold text-slate-100 mt-6 mb-2">Jadwal Pertandingan Tenis Meja </div>
...
<script>
    ...
    import { getTenis, getAllCabor, getTenisLocation } from '@/api/caborService';
    ...
    export default {
        ...
        methods: {
            ...
            async loadData() {
            this.rows = await getTenis();
            },
            async loadCabor() {
                this.caborList = await getAllCabor();
            },
            async location() {
                this.lokasi = await getTenisLocation();
            },
        },
    }
</script>
