<template>
    <div class="text-center">
        <Head>
            <Title>Jadwal Pertandingan Badminton di RW 09 Sukamulya Cikupa</Title>
            <Meta
            name="description"
            content="jadwal Pertandingan Badminton RW 09 Sukamulya kecamatan cikupa Tangerang"
            />
        </Head>
        ...
        <div class="h-full bg-gradient-to-r from-cyan-500 to-blue-500 border-solid py-2 px-3 rounded-md mb-11">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async loadData() {
            this.rows = await getBadminton();
            },
            async loadCabor() {
                this.caborList = await getAllCabor();
            },
            async location() {
                this.lokasi = await getBadmintonLocation();
            },
        },
    }
</script>
