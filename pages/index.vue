    ...
    <div class="p-2">
      <div class="grid grid-cols-4 gap-y-6">
        <NuxtLink to="/pengurus-rt" class="flex flex-col items-center py-3">
          ...
          <span class="px-1 text-center text-xs font-bold">Pengurus RT</span>
        </NuxtLink>
        <NuxtLink to="/keuangan" class="flex flex-col items-center py-3">
          ...
          <span class="px-1 text-center text-xs font-bold">Data Keuangan</span>
        </NuxtLink>
        <nuxt-link to="/pengurus-rw">
          <div class="flex flex-col items-center py-3">
            <div class="mb-2 flex h-12 w-12 justify-end">
              <div class="inline-block h-[46px] w-[46px]">
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="46" height="46">
            ...
            <span class="px-1 text-center text-xs font-bold">Pengurus RW</span>
          </div>
        </nuxt-link>
        ...
        <div class="flex flex-col items-center py-3">
          ...
          <span class="px-1 text-center text-xs font-bold">Data Penduduk</span>
        </div>
      </nuxt-link>
      <nuxt-link to="/agenda-kegiatan">
        <div class="flex flex-col items-center py-3">
          ...
          <span class="px-1 text-center text-xs font-bold">Agenda Kegiatan</span>
        </div>
      </nuxt-link>
      <nuxt-link to="/galery-foto">
        <div class="flex flex-col items-center py-3">
          ...
          <span class="px-1 text-center text-xs font-bold">Galery Foto</span>
        </div>
      </nuxt-link>
      <nuxt-link to="/petugas-security">
        <div class="flex flex-col items-center py-3">
          ...
          <span class="px-1 text-center text-xs font-bold">Petugas Security</span>
        </div>
      </nuxt-link>
      <nuxt-link to="/">
        <div class="flex flex-col items-center py-3">
          ...
          <span class="px-1 text-center text-xs font-bold">Program Kerja</span>
        </div>
      </nuxt-link>
      </div>
    </div>
