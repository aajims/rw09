    ...
    <div class="p-2">
      <div class="grid grid-cols-4 gap-y-6">
        ...
        <NuxtLink to="/keuangan" class="flex flex-col items-center py-3">
          <div class="mb-2 flex h-8 md:h-12 w-8 md:w-12 justify-end">
          <span class="inline-block h-[38px] md:h-[46px] w-[38px] w-[46px]">
        ...
        <nuxt-link to="/pengurus-rw">
          <div class="flex flex-col items-center py-3">
            <div class="mb-2 flex h-8 md:h-12 w-8 md:w-12 justify-end">
              <div class="inline-block h-[38px] md:h-[46px] w-[38px] w-[46px]">
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
      ...
      <nuxt-link to="/">
        <div class="flex flex-col items-center py-3">
          ...
          <span class="px-1 text-center text-[10px] md:text-xs font-bold">Program Kerja</span>
        </div>
      </nuxt-link>
      </div>
    </div>
